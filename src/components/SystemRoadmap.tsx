          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 border border-cyan-500/20 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm flex-shrink-0">1</div>
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">Configure sua empresa</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Na aba "Agente", preencha o nome da empresa e do agente de IA</p>
                </div>
              </div>
              
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm flex-shrink-0">2</div>
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">Personalize o prompt</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Edite o prompt do sistema com as informações do seu negócio ou use o "Gerar com IA"</p>
                </div>
              </div>
              
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm flex-shrink-0">3</div>
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">Conecte o WhatsApp</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Na aba "APIs", configure o Access Token e Phone Number ID do WhatsApp Cloud API</p>
                </div>
              </div>
              
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm flex-shrink-0">4</div>
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">Configure o Webhook</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Copie a URL e o Verify Token para configurar no Meta for Developers</p>
                </div>
              </div>
              
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm flex-shrink-0">✓</div>
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">Pronto!</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Seu agente está configurado e pronto para receber mensagens no WhatsApp</p>
                </div>
              </div>
            </div>
          </div>
          
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-gray-200 dark:bg-slate-800 rounded-full text-xs text-gray-600 dark:text-slate-300">⏱️ Tempo estimado: 15-30 minutos</span>
              <span className="px-3 py-1 bg-gray-200 dark:bg-slate-800 rounded-full text-xs text-gray-600 dark:text-slate-300">💰 Custo: Gratuito para começar</span>
              <span className="px-3 py-1 bg-gray-200 dark:bg-slate-800 rounded-full text-xs text-gray-600 dark:text-slate-300">📋 Pré-requisito: Conta Meta/Facebook</span>
            </div>
          </div>

          {/* Passo 1: Criar conta no Meta for Developers */}
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">1</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Criar conta no Meta for Developers</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Configure sua conta de desenvolvedor no Meta</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Acesse o portal de desenvolvedores do Meta:</p>
                    <a 
                      href="https://developers.facebook.com" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:bg-slate-700 rounded-lg text-cyan-400 text-sm transition-colors"
                    >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Faça login com sua conta do Facebook/Meta</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">1.3</span>
                  <p className="text-gray-600 dark:text-slate-300">Se for sua primeira vez, aceite os termos de desenvolvedor</p>
                </div>
              </div>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">2</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Criar um App no Meta</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Crie um aplicativo para usar a WhatsApp API</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">No painel, clique em <strong className="text-gray-900 dark:text-white">"My Apps"</strong> → <strong className="text-gray-900 dark:text-white">"Create App"</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.2</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Selecione o tipo de app: <strong className="text-emerald-400">"Business"</strong></p>
                    <p className="text-gray-500 dark:text-slate-500 text-xs mt-1">Este tipo permite acesso à WhatsApp Business API</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.3</span>
                  <p className="text-gray-600 dark:text-slate-300">Dê um nome ao seu app (ex: "Minha Empresa - WhatsApp Bot")</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.4</span>
                  <p className="text-gray-600 dark:text-slate-300">Preencha seu email de contato e clique em <strong className="text-gray-900 dark:text-white">"Create App"</strong></p>
                </div>
              </div>
              
              <div className="bg-gray-200 dark:bg-slate-800 rounded-lg p-4 border border-gray-300 dark:border-slate-700">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">3</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Adicionar WhatsApp ao App</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Configure o produto WhatsApp no seu app</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">No menu lateral, clique em <strong className="text-gray-900 dark:text-white">"Add Products"</strong> ou <strong className="text-gray-900 dark:text-white">"Adicionar Produtos"</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.2</span>
                  <p className="text-gray-600 dark:text-slate-300">Encontre <strong className="text-emerald-400">"WhatsApp"</strong> na lista e clique em <strong className="text-gray-900 dark:text-white">"Set up"</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.3</span>
                  <p className="text-gray-600 dark:text-slate-300">Selecione ou crie uma <strong className="text-gray-900 dark:text-white">Meta Business Account</strong> (conta comercial)</p>
                </div>
              </div>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">4</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Obter o Access Token</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Token de autenticação para a API</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">No menu lateral, vá em <strong className="text-gray-900 dark:text-white">WhatsApp</strong> → <strong className="text-gray-900 dark:text-white">API Setup</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">4.2</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Localize a seção <strong className="text-gray-900 dark:text-white">"Temporary access token"</strong></p>
                    <p className="text-gray-500 dark:text-slate-500 text-xs mt-1">Este token expira em 24 horas - ideal para testes</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">4.3</span>
                  <p className="text-gray-600 dark:text-slate-300">Clique em <strong className="text-gray-900 dark:text-white">"Copy"</strong> para copiar o token</p>
                </div>
              </div>
              
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Exemplo de Access Token:</p>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">5</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Obter Phone Number ID e Business Account ID</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Identificadores únicos do seu número e conta</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Na mesma página <strong className="text-gray-900 dark:text-white">API Setup</strong>, role para baixo</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">5.2</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Localize <strong className="text-emerald-400">"Phone number ID"</strong></p>
                    <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-3 mt-2">
                      <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Exemplo:</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Localize <strong className="text-emerald-400">"WhatsApp Business Account ID"</strong></p>
                    <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-3 mt-2">
                      <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Exemplo:</p>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">6</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Configurar Webhook</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Conecte o Meta ao seu sistema para receber mensagens</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">No seu sistema, vá em <strong className="text-gray-900 dark:text-white">Configurações</strong> → <strong className="text-gray-900 dark:text-white">APIs</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.2</span>
                  <p className="text-gray-600 dark:text-slate-300">Copie a <strong className="text-emerald-400">URL do Webhook</strong> e o <strong className="text-emerald-400">Verify Token</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.3</span>
                  <p className="text-gray-600 dark:text-slate-300">No Meta, vá em <strong className="text-gray-900 dark:text-white">WhatsApp</strong> → <strong className="text-gray-900 dark:text-white">Configuration</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.4</span>
                  <p className="text-gray-600 dark:text-slate-300">Na seção <strong className="text-gray-900 dark:text-white">"Webhook"</strong>, clique em <strong className="text-gray-900 dark:text-white">"Edit"</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.5</span>
                  <p className="text-gray-600 dark:text-slate-300">Cole a <strong className="text-gray-900 dark:text-white">Callback URL</strong> (URL do Webhook do seu sistema)</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.6</span>
                  <p className="text-gray-600 dark:text-slate-300">Cole o <strong className="text-gray-900 dark:text-white">Verify Token</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">6.7</span>
                  <p className="text-gray-600 dark:text-slate-300">Clique em <strong className="text-gray-900 dark:text-white">"Verify and Save"</strong></p>
                </div>
              </div>
              
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Formato da URL do Webhook:</p>
                <code className="text-xs text-emerald-400 font-mono break-all">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">7</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Selecionar Eventos do Webhook</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Configure quais eventos serão enviados ao seu sistema</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Após verificar o webhook, clique em <strong className="text-gray-900 dark:text-white">"Manage"</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">7.2</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300 mb-2">Ative (Subscribe) os seguintes eventos:</p>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 bg-gray-200 dark:bg-slate-800 px-3 py-2 rounded">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                        <code className="text-emerald-400 text-sm">messages</code>
                        <span className="text-gray-500 dark:text-slate-500 text-xs">- Receber mensagens dos clientes</span>
                      </div>
                      <div className="flex items-center gap-2 bg-gray-200 dark:bg-slate-800 px-3 py-2 rounded">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                        <code className="text-emerald-400 text-sm">message_echoes</code>
                        <span className="text-gray-500 dark:text-slate-500 text-xs">- Confirmação de mensagens enviadas</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-200 dark:bg-slate-800 rounded-lg p-4 border border-gray-300 dark:border-slate-700">
                <p className="text-xs text-gray-500 dark:text-slate-400">
                  <strong className="text-gray-600 dark:text-slate-300">Opcional:</strong> Você também pode ativar{' '}
          ...
          <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-600 dark:text-slate-300 text-sm">App criado no Meta for Developers</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">WhatsApp adicionado como produto</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">Access Token copiado e configurado</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">Phone Number ID copiado e configurado</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">Business Account ID copiado e configurado</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">Webhook configurado e verificado no Meta</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded border-2 border-emerald-400 flex items-center justify-center">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
                <p className="text-gray-600 dark:text-slate-300 text-sm">Eventos <code className="text-cyan-400">messages</code> e <code className="text-cyan-400">message_echoes</code> ativados</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <ul className="text-gray-500 dark:text-slate-400 text-sm space-y-1">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-3 bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:bg-slate-700 rounded-lg transition-colors"
              >
                <ExternalLink className="w-4 h-4 text-cyan-400" />
                <span className="text-gray-600 dark:text-slate-300 text-sm">Documentação oficial WhatsApp Cloud API</span>
              </a>
              <a 
              ...
              >
                <ExternalLink className="w-4 h-4 text-cyan-400" />
                <span className="text-gray-600 dark:text-slate-300 text-sm">Meta Business Settings</span>
              </a>
              <a 
              ...
              >
                <ExternalLink className="w-4 h-4 text-cyan-400" />
                <span className="text-gray-600 dark:text-slate-300 text-sm">Referência da API de Mensagens</span>
              </a>
              <a 
              ...
              >
                <ExternalLink className="w-4 h-4 text-cyan-400" />
                <span className="text-gray-600 dark:text-slate-300 text-sm">Documentação de Webhooks</span>
              </a>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Fluxo de Dados Principal</h4>
...
WhatsApp Cloud API (resposta ao cliente)`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-slate-800">
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/dashboard</td>
                  <td className="p-4 text-gray-900 dark:text-white">Dashboard.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Métricas principais, KPIs, gráficos de performance</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/chat</td>
                  <td className="p-4 text-gray-900 dark:text-white">ChatInterface.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Interface de conversas WhatsApp com sidebar de contatos</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/pipeline</td>
                  <td className="p-4 text-gray-900 dark:text-white">Kanban.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Pipeline de vendas/CRM com IA integrada para movimentação automática de deals</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/contacts</td>
                  <td className="p-4 text-gray-900 dark:text-white">Contacts.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Lista completa de contatos com filtros e tags</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/scheduling</td>
                  <td className="p-4 text-gray-900 dark:text-white">Scheduling.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Calendário de agendamentos com criação de reuniões</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/team</td>
                  <td className="p-4 text-gray-900 dark:text-white">Team.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Gestão de times, membros e funções</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/settings</td>
                  <td className="p-4 text-gray-900 dark:text-white">Settings.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Configurações do agente IA, integrações de APIs e documentação do sistema</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">/meeting/:id</td>
                  <td className="p-4 text-gray-900 dark:text-white">MeetingRoom.tsx</td>
                  <td className="p-4 text-gray-500 dark:text-slate-400">Sala de reunião virtual (rota externa)</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Modais e Componentes Especiais</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                ...
                <p className="text-gray-500 dark:text-slate-500 text-xs">Criação de novos deals no CRM</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-emerald-400 font-bold text-xs mb-1">LostReasonModal</p>
                <p className="text-gray-500 dark:text-slate-500 text-xs">Captura motivo de perda de deal</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-violet-400 font-bold text-xs mb-1">PipelineSettingsModal</p>
                <p className="text-gray-500 dark:text-slate-500 text-xs">Configuração de estágios do funil</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-amber-400 font-bold text-xs mb-1">TeamConfigModal</p>
                <p className="text-gray-500 dark:text-slate-500 text-xs">Gestão de times e funções</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-pink-400 font-bold text-xs mb-1">TagSelector</p>
                <p className="text-gray-500 dark:text-slate-500 text-xs">Seleção e criação de tags</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-blue-400 font-bold text-xs mb-1">PromptGeneratorSheet</p>
                <p className="text-gray-500 dark:text-slate-500 text-xs">Geração de prompts com IA</p>
              </div>
            </div>

            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Componentes Principais</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6 mt-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4 flex items-center gap-2">
              <Layers className="w-5 h-5 text-cyan-400" />
              Componentes Reutilizáveis
            </h4>
            <p className="text-gray-600 dark:text-slate-300 mb-4">Componentes compartilhados em <code className="text-cyan-400">src/components/</code>:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-500 dark:text-slate-400 mb-6">
              <li><strong className="text-gray-900 dark:text-white">Button.tsx</strong>: Botão customizado com variants</li>
              <li><strong className="text-gray-900 dark:text-white">Sidebar.tsx</strong>: Menu lateral com navegação</li>
              <li><strong className="text-gray-900 dark:text-white">TagSelector.tsx</strong>: Seletor de tags para contatos</li>
              <li><strong className="text-gray-900 dark:text-white">CreateDealModal.tsx</strong>: Modal para criar deals</li>
              <li><strong className="text-gray-900 dark:text-white">LostReasonModal.tsx</strong>: Modal para marcar deal como perdido</li>
              <li><strong className="text-gray-900 dark:text-white">PipelineSettingsModal.tsx</strong>: Configuração de estágios</li>
              <li><strong className="text-gray-900 dark:text-white">TeamConfigModal.tsx</strong>: Gestão de times e funções</li>
            </ul>

            <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-5">
              <h5 className="text-lg font-semibold text-cyan-400 mb-3">🎨 Button Component Customizado</h5>
              <p className="text-gray-600 dark:text-slate-300 mb-3">O componente <code className="text-cyan-400">Button.tsx</code> utiliza <code className="text-cyan-400">class-variance-authority</code> para variants tipadas:</p>
              
              <div className="bg-gray-100 dark:bg-slate-900 rounded-lg p-4 mb-4">
                <pre className="text-sm text-gray-600 dark:text-slate-300 overflow-x-auto">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-slate-800">
                <tr>
                  ...
                  <td className="p-4 text-gray-600 dark:text-slate-300">Recebe webhooks do WhatsApp Cloud API, processa mensagens recebidas</td>
                ...
                <tr>
                  ...
                  <td className="p-4 text-gray-600 dark:text-slate-300">Processa fila de envio, envia mensagens via WhatsApp Cloud API</td>
                  <td className="p-4 text-amber-400">verify_jwt: true</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-blue-400">analyze-conversation</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Análise de conversa com IA, extração de insights, movimentação automática de deals</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-pink-400">generate-prompt</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Gerador de system prompts personalizados usando Gemini 3 Pro</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">simulate-webhook</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Simula mensagens recebidas para testes (desenvolvimento)</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">trigger-whatsapp-sender</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Trigger auxiliar para chamar whatsapp-sender via HTTP</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">seed-appointments</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Popula tabela appointments com dados de exemplo (desenvolvimento)</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-gray-500 dark:text-slate-400">test-whatsapp-message</td>
                  <td className="p-4 text-gray-600 dark:text-slate-300">Envia mensagem de teste via WhatsApp Cloud API</td>
                  <td className="p-4 text-gray-500 dark:text-slate-500">verify_jwt: false</td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Arquitetura de Chamadas</h4>
            <p className="text-sm text-gray-500 dark:text-slate-400 mb-4">
              As Edge Functions se comunicam diretamente via <code className="text-cyan-400 bg-white dark:bg-slate-950 px-2 py-1 rounded">fetch()</code> com autenticação via SERVICE_ROLE_KEY:
            </p>
            <pre className="text-xs text-gray-600 dark:text-slate-300 font-mono bg-white dark:bg-slate-950 p-4 rounded border border-gray-300 dark:border-slate-700 overflow-x-auto">
...
const response = await fetch(
  \`\${SUPABASE_URL}/functions/v1/nina-orchestrator\`,
  {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6 mb-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4 flex items-center gap-2">
              <Database className="w-5 h-5 text-cyan-400" />
              📊 Diagrama de Relacionamentos (ER)
            </h4>
            <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
              <pre className="text-xs text-gray-600 dark:text-slate-300 overflow-x-auto whitespace-pre">
{`erDiagram
    ...
    deals {
        ...
        text stage
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-4 flex items-start gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-5">
              ...
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-3">Armazena dados dos contatos/clientes</p>
            ...
            <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-5">
              ...
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-3">Oportunidades no pipeline CRM</p>
              <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
            ...
            <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-5">
              ...
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-3">Estágios customizáveis do funil</p>
              <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
            ...
            <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-5">
              ...
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-3">Agendamentos e reuniões</p>
              <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
            ...
            <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-5">
              <h4 className="text-gray-500 dark:text-slate-400 font-bold mb-3 text-sm">team_members / teams</h4>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-3">Estrutura de equipe e funções</p>
              <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-500 dark:text-slate-400 text-xs">→ Mensagens aguardando envio via WhatsApp</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-violet-400 font-mono text-xs">message_processing_queue</span>
                <span className="text-gray-500 dark:text-slate-400 text-xs">→ Fila de mensagens brutas recebidas do webhook</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gray-500 dark:text-slate-400 font-mono text-xs">message_grouping_queue</span>
                <span className="text-gray-500 dark:text-slate-400 text-xs">→ Agrupamento temporário de mensagens do webhook</span>
              </div>
            </div>
          </div>

          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Tabelas Adicionais</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-4">
                <h5 className="text-cyan-400 font-bold text-sm mb-2">conversation_states</h5>
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Estado de máquina para conversas</p>
                <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Atividades vinculadas a deals</p>
                <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Definições de tags do sistema</p>
                <ul className="text-xs text-gray-500 dark:text-slate-500 space-y-1 font-mono">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                ...
                <p className="text-gray-500 dark:text-slate-400 text-xs">Atomicamente busca e marca mensagens como 'processing' na send_queue</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-violet-400 font-mono text-xs mb-1">claim_message_processing_batch(p_limit)</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Atomicamente busca e marca webhooks na message_processing_queue</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-amber-400 font-mono text-xs mb-1">get_or_create_conversation_state(p_conversation_id)</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Retorna o estado da conversa ou cria um novo se não existir</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-pink-400 font-mono text-xs mb-1">update_conversation_state(p_conversation_id, p_new_state, ...)</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Atualiza o estado da máquina de conversas com contexto e ação</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-blue-400 font-mono text-xs mb-1">update_client_memory(p_contact_id, p_new_memory)</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Atualiza o JSONB client_memory de um contato</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-orange-400 font-mono text-xs mb-1">cleanup_processed_queues()</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Remove registros antigos das filas de processamento (&gt;24h completed, &gt;7d failed)</p>
              </div>
            </div>
          </div>

          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Database Triggers</h4>
            <div className="space-y-3">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                ...
                <p className="text-gray-500 dark:text-slate-400 text-xs">Trigger <code className="text-gray-500 dark:text-slate-500">AFTER INSERT</code> em messages que atualiza last_message_at nas conversations e last_activity nos contacts</p>
              </div>
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded p-3">
                <p className="text-violet-400 font-bold text-xs mb-1">create_deal_for_new_contact</p>
                <p className="text-gray-500 dark:text-slate-400 text-xs">Trigger <code className="text-gray-500 dark:text-slate-500">AFTER INSERT</code> em contacts que automaticamente cria um deal no estágio 'new'</p>
              </div>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Tipos Enumerados do PostgreSQL</h4>
            <p className="text-sm text-gray-500 dark:text-slate-400 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Tipo de compromisso agendado</p>
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Papel do membro da equipe</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Status do membro</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
                  <li>• active (ativo)</li>
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Status de entrega da mensagem</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
                  <li>• sent (enviada)</li>
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Tipo de mídia da mensagem</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
                  <li>• text (texto)</li>
                  <li>• audio (áudio)</li>
                  <li>• image (imagem)</li>
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Status de itens nas filas</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Time de atendimento atribuído</p>
                <ul className="text-xs text-gray-600 dark:text-slate-300 space-y-1 font-mono">
                  <li>• mateus</li>
                  <li>• igor</li>
                  <li>• fe</li>
...
└─────────────────────────────────────────────────────────────┘`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Custom Hooks</h4>
            <div className="space-y-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3 mb-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Funcionalidades:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Realtime Subscriptions:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3 mt-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Detalhes de Implementação:</p>
                  <pre className="text-xs text-gray-500 dark:text-slate-400 font-mono overflow-x-auto">
...
// 4. Realtime detecta INSERT → deduplicação ignora (ID real já existe)`}
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Valores Expostos:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <pre className="text-xs text-gray-600 dark:text-slate-300 font-mono overflow-x-auto">
  ...
  <DesktopLayout />
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">src/services/api.ts (1182 linhas)</h4>
            <p className="text-sm text-gray-500 dark:text-slate-400 mb-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Tipos Principais (src/types.ts)</h4>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <pre className="text-xs text-gray-600 dark:text-slate-300 font-mono bg-gray-100 dark:bg-slate-900 p-3 rounded overflow-x-auto">
  ...
  interaction_summary: {
    ...
    preferred_contact_time: string;
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Motivo:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
                ...
                <pre className="text-xs text-gray-600 dark:text-slate-300 font-mono bg-gray-100 dark:bg-slate-900 p-3 rounded overflow-x-auto mt-3">
{`// useConversations.ts
  ...
  return {
    ...
    unreadCount: calculateUnread(dbConv.messages),
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-1">transformDBToUIConversation(dbConv, messages)</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400">Converte DBConversation + DBMessage[] para UIConversation com hidratação de objetos</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-1">transformDBToUIMessage(dbMsg)</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400">Converte DBMessage para UIMessage, mapeia status/type/direction</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-1">formatRelativeTime(date)</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400">Formata data em texto relativo: "há 2 horas", "ontem", "há 3 dias"</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-1">formatMessageTime(timestamp)</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400">Formata timestamp para hora legível: "14:30"</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-1">getDefaultClientMemory()</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400">Factory que retorna estrutura ClientMemory inicial com valores default</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Sistemas Complexos Implementados</h4>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Fluxo:</p>
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Variáveis disponíveis:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1 font-mono">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3 mb-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Automações:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
              ...
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-900 rounded p-3">
                  <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Configuração:</p>
                  <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Editável em Settings → Agente → Informações da Empresa</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-cyan-400">•</span>
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Sidebar, ChatInterface, Settings, status labels, prompts dinâmicos</span>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Editável manualmente ou gerar com IA (Gemini 3 Pro)</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Flash, Pro 2.5, Pro 3, ou Adaptive Mode</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Dias da semana + faixa de horário (ex: 09:00 - 18:00)</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Delays entre mensagens, quebra de texto em chunks</span>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Access Token + Phone Number ID + Verify Token</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-violet-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">API Key + Voice ID + configurações avançadas (stability, speed, style)</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-violet-400">•</span>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Criar/editar/reordenar/deletar estágios via modal de configuração</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-amber-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Marcar como Manual ou Automático + definir critérios de trigger</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-amber-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Criar tags customizadas com cores e categorias</span>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Criar/editar times com nome, descrição e cor</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-pink-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Criar/editar funções (ex: SDR, Closer, CS, Suporte)</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-pink-400">•</span>
                      <div>
                        ...
                        <span className="text-gray-500 dark:text-slate-400">Adicionar agentes com nome, email, função, time, peso de distribuição</span>
                      </div>
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-2 font-mono">
                    <li className="flex items-start gap-2">
                      <span className="text-cyan-400">•</span>
                ...
                <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 dark:text-slate-300 space-y-1 font-mono pl-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <h4 className="text-gray-900 dark:text-white font-bold mb-4">Guia de Modificações</h4>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                  ...
                  <pre className="text-xs text-gray-500 dark:text-slate-400 font-mono bg-gray-100 dark:bg-slate-900 p-3 rounded mt-3 overflow-x-auto">
{`// App.tsx
  ...
  FOR ALL USING (true) WITH CHECK (true);`}
              ...
              <div>
                ...
                <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                  ...
                  <div className="bg-gray-100 dark:bg-slate-900 rounded p-3 mb-3">
                    <p className="text-xs text-gray-600 dark:text-slate-300 font-mono mb-2">Conjuntos de mock data disponíveis:</p>
                    <ul className="text-xs text-gray-500 dark:text-slate-400 space-y-1">
              ...
              <div>
                ...
                <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4">
                  ...
                  <div className="bg-gray-100 dark:bg-slate-900 rounded-lg p-4 mb-4">
                    <pre className="text-xs text-gray-600 dark:text-slate-300 overflow-x-auto">
{`const menuItems = [
...
// 4. Crie o componente da página em src/components/`}
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-400 flex items-start gap-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">1</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Configurar verify_jwt = false nas Edge Functions</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Webhooks e funções do sistema precisam aceitar requisições externas</p>
              </div>
            </div>
            
            <div className="space-y-4 ml-14">
              <p className="text-gray-600 dark:text-slate-300 text-sm">
                No arquivo <code className="text-cyan-400 bg-gray-200 dark:bg-slate-800 px-2 py-0.5 rounded">supabase/config.toml</code>, adicione as seguintes configurações:
              </p>
              
              <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-4 overflow-x-auto">
...
verify_jwt = false`}</pre>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">2</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Configurar Webhook no Meta for Developers</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Conectar o WhatsApp Business API ao seu sistema</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.1</span>
                  <p className="text-gray-600 dark:text-slate-300">Acesse <a href="https://developers.facebook.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 underline">developers.facebook.com</a> → Seu App → WhatsApp → Configuration</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.2</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Configure o Callback URL (copie de Configurações → APIs):</p>
                    <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-3 mt-2">
                      <code className="text-xs text-emerald-400 font-mono break-all">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">2.3</span>
                  <div>
                    <p className="text-gray-600 dark:text-slate-300">Configure o Verify Token (copie de Configurações → APIs):</p>
                    <div className="bg-white dark:bg-slate-950 border border-gray-300 dark:border-slate-700 rounded-lg p-3 mt-2">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Em <strong className="text-gray-900 dark:text-white">"Webhook fields"</strong>, inscreva-se em: <code className="text-cyan-400">messages</code></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg flex-shrink-0">3</div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-bold text-lg">Configurar ElevenLabs API Key (Opcional)</h4>
                <p className="text-gray-500 dark:text-slate-400 text-sm">Apenas se quiser respostas em áudio</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.1</span>
                  <p className="text-gray-600 dark:text-slate-300">Crie uma conta em <a href="https://elevenlabs.io" target="_blank" rel="noopener noreferrer" className="text-cyan-400 underline">elevenlabs.io</a></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.2</span>
                  <p className="text-gray-600 dark:text-slate-300">Vá em Profile → API Key e copie sua chave</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.3</span>
                  <p className="text-gray-600 dark:text-slate-300">Cole a chave em <strong className="text-gray-900 dark:text-white">Configurações → APIs → ElevenLabs API Key</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-cyan-400 font-bold">3.4</span>
                  <p className="text-gray-600 dark:text-slate-300">Ative <strong className="text-gray-900 dark:text-white">"Resposta em Áudio"</strong> na aba Agente</p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-300">
                <div className="w-5 h-5 rounded border border-gray-300 dark:border-slate-600 flex items-center justify-center text-xs">☐</div>
    ...
    <div className="space-y-4 pb-20">
      ...
      {sections.map((section) => {
        ...
        return (
          <div
            key={section.id}
            className="bg-gray-100/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-xl overflow-hidden hover:border-gray-300 dark:border-slate-700 transition-colors"
          >
            <button
              onClick={() => toggleSection(section.id)}
              className="w-full p-5 flex items-center justify-between hover:bg-gray-100/80 dark:bg-slate-900/80 transition-colors"
            >
              <div className="flex items-center gap-3">
            ...
            {isExpanded && (
              <div className="p-6 pt-0 border-t border-gray-200/50 dark:border-slate-800/50 animate-in fade-in duration-200">
                {section.content}
              </div>
            )}
          </div>
